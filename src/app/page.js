          ...
          <section className="pb-32 md:pb-5 justify-center min-h-screen flex flex-wrap gap-8 md:gap-16 items-start px-4 md:px-4">
            <div className="bg-dark-blue py-7 px-10 rounded-custom outer-glow hover:select-none w-full md:w-1/2 lg:w-1/3">
              ...
              <div className="flex justify-between">
                <p className="text-md py-0 leading-6 tracking-wider text-gray-400 max-w-screen-md font-custom">
                  Hi, I'm <span class="text-white">Jack Sheehy</span>. I'm
                  currently a student in{" "}
                  <span class="text-white">TU Dublin </span>
                  studying <span class="text-white">Business Computing</span>.
                  My passion for technology started at a young age, so it was a
                  natural choice for me to pursue a career in that field as I
                  got older.
                </p>
                <Image
            ...
            <div className="bg-dark-blue py-7 px-10 rounded-custom outer-glow hover:select-none w-full md:w-1/2 lg:w-1/3">
              ...
              <p className="text-md py-4 leading-6 tracking-wider text-gray-400 max-w-screen-md font-custom ">
                As a<span class="text-white"> Business Computing</span> student,
                I cover a diverse range of topics such as{" "}
                <span class="text-white">
                  Object-Oriented Programming, Web Development, Algorithms, Data
                  Structures
                </span>
                , as well as<span class="text-white"> business</span>. We have a
                primary focus on
                <span class="text-white"> Java</span>, though outside of
                coursework I'm learning other languages and frameworks such as
                <span class="text-white">
                  {" "}
                  React, Spring Boot, Javascript, Python{" "}
                </span>{" "}
                and more. In the future, I'd like to learn{" "}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 place-items-center justify-items-center pb-8 mx-auto max-w-5xl">
              ...
              <div class="max-w-xs bg-dark-blue py-4 px-1 rounded-custom outer-glow hover:select-none">
                <div class="px-3 py-2">
                  ...
                  <p class="text-md pt-1 pb-1 px-2 leading-6 tracking-wider text-gray-400 max-w-screen-md font-custom text-sm">
                    My first attempt at a personal website. Displays my
                    information, projects I have completed, as well as what I am
                    learning.
                  </p>
                </div>
                <div class="px-6 pt-0 pb-2">
